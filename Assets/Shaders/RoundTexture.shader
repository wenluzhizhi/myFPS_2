       ...
       pass{
              ...
              fixed4 frag(v2f i):SV_Target{
                  ...
                  half2 u_n_x_l1=i.uv-float2(_MainTex_TexelSize.x,0)*_burnSize;
                   ...
                   half2 u_n_y_l2=i.uv-float2(0,_MainTex_TexelSize.y*2)*_burnSize;
                  half2 u_n_y_l1=i.uv-float2(0,_MainTex_TexelSize.y)*_burnSize;


                   half2 u_n_y_r2=i.uv+float2(0,_MainTex_TexelSize.y*2)*_burnSize;
                   half2 u_n_y_r1=i.uv+float2(0,_MainTex_TexelSize.y)*_burnSize;
